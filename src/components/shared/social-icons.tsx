...
// Icônes de marques en SVG (viewBox 24x24, fill currentColor)
const SOCIAL_SVGS: Record<string, string> = {
  ...
  tiktok:
    'M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.88-2.88 2.89 2.89 0 012.88-2.88c.28 0 .54.04.79.1v-3.5a6.37 6.37 0 00-.79-.05A6.34 6.34 0 003.15 15a6.34 6.34 0 0010.68 4.61V12.7a8.28 8.28 0 005.76 2.29V11.5a4.83 4.83 0 01-3.77-1.58V6.69h3.77z',
  linkedin:
...
const FALLBACK_WHATSAPP = 'https://wa.me/245956007371';

/**
 * SocialIconsRow — gros icônes ronds des réseaux sociaux de la plateforme.
 * Les liens viennent des réglages (/api/settings) ; à défaut :
    ...
    fetch('/api/settings')
      ...
      .then((config) => {
        setLinks({
          ...
          whatsapp: config.whatsapp || FALLBACK_WHATSAPP,
        });
      })
      .catch(() => setLinks({ whatsapp: FALLBACK_WHATSAPP }));
  }, []);
